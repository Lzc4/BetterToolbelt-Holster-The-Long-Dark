...
Works exactly like a permanent passive perk
No equip slot required anymore

Supported rifles include:
...
This mod was built to solve a major gameplay issue:

Late-game rewards in vanilla compete with essential equipment slots, making them objectively hard to justify despite being difficult quest rewards.

This mod redesigns those rewards into permanent progression unlocks while preserving balance:
...
Special thanks to the Hinterland Studio community modding scene for collectively suffering through undocumented IL2CPP behavior together.
